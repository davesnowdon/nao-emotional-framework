  ...
  : AL::ALModule(broker, name)
{
  ...
  BIND_METHOD(EmotionalTextToSpeech::printHello);
  ...
  BIND_METHOD(EmotionalTextToSpeech::printWord);
  ...
  BIND_METHOD(EmotionalTextToSpeech::returnTrue);
...
void EmotionalTextToSpeech::init()
{
  /**
...
void EmotionalTextToSpeech::printHello()
{
  std::cout << "Hello!" << std::endl;
}

void EmotionalTextToSpeech::printWord(const std::string &word)
{
  std::cout << word << std::endl;
}

bool EmotionalTextToSpeech::returnTrue()
{
  return true;
}
